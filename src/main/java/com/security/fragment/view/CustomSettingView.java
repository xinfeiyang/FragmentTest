...
public class CustomSettingView extends LinearLayout {
    ...
    private void initAllViews() {
        ...
        float f= (float) SharedPreferenceUtil.get(MyApplication.getContext(),LyricView.KEY_TEXT_SIZE,15.0f);
        mTextSizeSeek.setProgress((int) (((float) SharedPreferenceUtil.get(MyApplication.getContext(),LyricView.KEY_TEXT_SIZE,15.0f)-15.0f)*100/3.0f));
        ...
        mLineSpaceSeek.setProgress((int) (( (float) SharedPreferenceUtil.get(MyApplication.getContext(),LyricView.KEY_LINE_SPACE,12.0f)- 12.0f) * 100 / 3.0f));
